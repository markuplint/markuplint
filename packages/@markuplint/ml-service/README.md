# @markuplint/ml-service

[![npm version](https://badge.fury.io/js/%40markuplint%2Fml-service.svg)](https://www.npmjs.com/package/@markuplint/ml-service)
...
```sh
$ npm install @markuplint/ml-service

$ yarn add @markuplint/ml-service
```
