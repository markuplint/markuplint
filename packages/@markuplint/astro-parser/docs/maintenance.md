...
1. Verify the failing fixture still reproduces by running `npx vitest run packages/@markuplint/astro-parser/src/parser.spec.ts -t "#3825"`.
...
See [#3825](https://github.com/markuplint/markuplint/issues/3825) for the original report.
