...
| Command                                        | Description            |
| ---------------------------------------------- | ---------------------- |
| `yarn build --scope @markuplint/datastar-spec` | Build this package     |
| `yarn dev --scope @markuplint/datastar-spec`   | Watch mode build       |
| `yarn clean --scope @markuplint/datastar-spec` | Remove build artifacts |
...
All Datastar attributes are global -- they are available on every HTML element.
...
4. Build: `yarn build --scope @markuplint/datastar-spec`
