...
| `checkDateStringWithOptionalTime`       | `date-string-with-optional-time.ts` | Date or global date-time      | `2024-01-15T14:30:00Z` | [del/ins datetime](https://html.spec.whatwg.org/multipage/edits.html#attr-mod-datetime)                                                          |
