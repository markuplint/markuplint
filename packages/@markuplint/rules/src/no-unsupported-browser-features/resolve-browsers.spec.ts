...
describe('resolveTargetBrowsers', () => {
	test('[no-unsupported-browser-features-invalid-001] returns browsers from explicit query', () => {
	...
	test('[no-unsupported-browser-features-invalid-002] returns null when no config and no filename', () => {
		const result = resolveTargetBrowsers(undefined, {});
		expect(result).toBeNull();
	});

	test('[no-unsupported-browser-features-invalid-003] keeps minimum version for duplicate browsers', () => {
	...
	test('[no-unsupported-browser-features-invalid-004] handles hyphenated version ranges', () => {
	...
	test('[no-unsupported-browser-features-invalid-005] skips unknown browsers', () => {
	...
	test('[no-unsupported-browser-features-invalid-006] supports array of queries', () => {
		const result = resolveTargetBrowsers(undefined, {
	...
	test('[no-unsupported-browser-features-invalid-007] provides display names', () => {
