...
class MLNodeList<T extends RuleConfigValue, O extends Object | null, N extends MLChildNode<T, O>>
	extends Array<N>
...
export function toNodeList<T extends RuleConfigValue, O extends Object | null, N extends MLChildNode<T, O>>(
