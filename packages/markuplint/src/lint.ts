import { MLResultInfo, MarkupLintOptions } from './types';
...
export async function lint(options: MarkupLintOptions) {
...
export function lintSync(options: MarkupLintOptions) {
	const rulesAutoResolve = options.rulesAutoResolve ?? true;
