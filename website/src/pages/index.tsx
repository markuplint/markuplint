				...
				<div className="body">
					...
					<section>
						...
						<p>
							...
							Pug, JSX(React), Vue, Svelte, Astro, PHP, eRuby, EJS, Mustache/Handlebars, Nunjucks, and
							Liquid. And it provides the API that creates the plugin for any markup language.
						</p>
					</section>
				</div>
			</main>
