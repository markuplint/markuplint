...
If you set other config file [paths](#Specification%20about%20paths), it merges the current setting with them.
...
Set a regex to the key, and the spec file [path](#Specification%20about%20paths) or a package name to the value.
