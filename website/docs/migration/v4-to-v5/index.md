...
| [deprecated-element](/docs/migration/v4-to-v5/rules/deprecated-element)                 | Split into `no-obsolete-element` (`error`) and `no-deprecated-element` (`warning`). Non-standard element detection moved to `no-nonstandard-features`.                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Config authors relying on non-standard detection                |
