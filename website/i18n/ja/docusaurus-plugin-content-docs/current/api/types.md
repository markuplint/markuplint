...
例えば、[`invalid-attr`](/rules/invalid-attr)ルールの`attrs.[any-attr-name].type`オプションで使用されています。
...
| `BrowsingContextName`          | `iframe[name]`ほか                      | [WHATWG](https://html.spec.whatwg.org/multipage/browsers.html#browsing-context-names)                              | ✅       |
...
また、**[CSSTree](https://github.com/csstree/csstree)**が定義されている型を使用できます。
