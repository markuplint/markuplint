...
| [deprecated-element](/docs/migration/v4-to-v5/rules/deprecated-element)                 | `no-obsolete-element`（`error`）と `no-deprecated-element`（`warning`）に2分割。非標準要素の検出が `no-nonstandard-features` に移管。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 非標準要素の検出に依存する設定作成者                             |
