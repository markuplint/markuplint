...
- generated: 2026-05-11T14:12:33.210Z
...
- files: **5442**
- match-error: **3270** (both tools flagged)
- match-clean: **919** (neither flagged)
- nu-only: **244** (only nu-validator flagged; markuplint coverage candidates — open a markuplint issue after a spec read)
- nu-over: **28** (nu-validator errors fully covered by spec-backed excluded-ids — confirmed over-detection)
- overall match rate: **77.0%**
...
| invalid-attr | 3086 | 91.5% | 2595 | 230 | 61 | 174 | 26 |
| required-attr | 5 | 100.0% | 5 | 0 | 0 | 0 | 0 |
| uncategorized | 1307 | 37.2% | 323 | 163 | 765 | 54 | 2 |
