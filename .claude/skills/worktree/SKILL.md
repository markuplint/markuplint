...
The `html5lib-tests` conformance suite is a git submodule under
`crates/markuplint-html-parser/tests/html5lib-tests/`. After cloning or creating
a worktree, initialize it:
