    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const filePath of ruleFiles) {
            if (/^markuplint-rule-[a-z\-]+\.js$/i.test(filePath)) {
                const ruleModule = yield Promise.resolve().then(function () { return require(path.resolve(ruleDir, filePath)); });
...
function getRuleset(dir) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const ruleset = yield Promise.resolve().then(function () { return require(rulesetFilePath); });
        return ruleset;
    });
}
