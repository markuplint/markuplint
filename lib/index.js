...
function verify(html, ruleset, rules, locale) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!locale) {
            locale = yield osLocale({ spawn: true });
        }
        return yield markuplint.verify(html, ruleset, rules, locale);
    });
}
exports.verify = verify;
function verifyFile(filePath, ruleset, rules, locale) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!locale) {
            locale = yield osLocale({ spawn: true });
        }
        ...
        const reports = yield markuplint.verify(html, ruleset, rules, locale);
        return {
            html,
            reports,
        };
