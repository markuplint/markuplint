...
const invalid_node_1 = require("./invalid-node");
const node_1 = require("./node");
const omitted_element_1 = require("./omitted-element");
const raw_text_1 = require("./raw-text");
const text_node_1 = require("./text-node");
const sync_walk_1 = require("./sync-walk");
const get_col_1 = require("../parser/get-col");
const get_line_1 = require("../parser/get-line");
class Document {
