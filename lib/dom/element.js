...
const is_potential_custom_element_name_1 = __importDefault(require("./parser/is-potential-custom-element-name"));
...
class Element extends node_1.default {
    constructor(nodeName, raw, line, col, startOffset, prevNode, nextNode, parentNode, attributes, namespaceURI, endTag) {
        ...
        this.isPotentialCustomElement = is_potential_custom_element_name_1.default(nodeName);
