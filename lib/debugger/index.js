...
(async () => {
    ...
    const coloredNodes = d.list.map(n => {
        if (n instanceof node_1.default) {
            switch (n.nodeName) {
                case '#doctype':
                    return cli_color_1.default.bgBlue.black(n.raw);
                case '#ws':
                    return cli_color_1.default.bgWhite.black(n.raw);
                case '#invalid':
                    return cli_color_1.default.bgRed.white(n.raw);
                case '#text':
                    return n.raw;
                case '#eof':
                    return cli_color_1.default.bgWhite.black(n.raw);
                case '#comment':
                    return cli_color_1.default.bgYellow.black(n.raw);
                default:
                    return cli_color_1.default.bgGreen.black(n.raw);
            }
        }
        return '';
    });
    const result = coloredNodes
